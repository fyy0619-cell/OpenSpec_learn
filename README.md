...
- [配套学习文档](#配套学习文档)
- [1. 一句话理解 OpenSpec](#1-一句话理解-openspec)
- [2. 为什么需要 OpenSpec](#2-为什么需要-openspec)
- [3. OpenSpec 的几个核心概念](#3-openspec-的几个核心概念)
- [4. 本仓库已经初始化的内容](#4-本仓库已经初始化的内容)
- [5. 安装和环境准备](#5-安装和环境准备)
- [6. 初始化一个真实项目](#6-初始化一个真实项目)
- [7. 完整工程流程：从想法到归档](#7-完整工程流程从想法到归档)
- [8. 常用命令速查](#8-常用命令速查)
- [9. Spec 写法详解](#9-spec-写法详解)
- [10. OpenSpec 和 AI 编程助手怎么配合](#10-openspec-和-ai-编程助手怎么配合)
- [11. 嵌入式 / IoT 项目使用建议](#11-嵌入式--iot-项目使用建议)
- [12. 常见错误](#12-常见错误)
- [13. 新手练习路线](#13-新手练习路线)
- [14. 本仓库验证命令](#14-本仓库验证命令)
- [15. 最后再记一遍](#15-最后再记一遍)
...
- [OpenSpec 实战练习手册](docs/openspec-practice-lab.md)：从 0 创建一个 change，练习 proposal、specs、design、tasks、validate 和 archive。
...
- [?????????EdgeCare Guardian](docs/resume-project-edgecare-guardian.md)???????WS63?MPU6050??? AI???????????????????????????
